package vn.com.cmc.springsecurity.filter;
        ...
        if (jwtService.validateTokenLogin(authToken)) {
            ...
            if (user != null) {
                ...
                UserDetails userDetail = new User(username, user.getPassWord(), enabled, accountNonExpired,
                        credentialsNonExpired, accountNonLocked, Arrays.stream(user.getRoles().split(",")).map(SimpleGrantedAuthority::new).collect(Collectors.toList()));
